...
const kitchenImg = new URL('../assets/NewPortfolio/Kitchen/Kitchen Remodeling - Miami Shores.webp', import.meta.url).href;
const bathroomImg = new URL('../assets/NewPortfolio/Bathroom/Bathroom Remodeling - Coral Gables.webp', import.meta.url).href;
const interiorImg = new URL('../assets/NewPortfolio/Home Additions/Hotel Remodeling - Sunny Isles Beach.webp', import.meta.url).href;
const homeImg = new URL('../assets/NewPortfolio/Home Additions/Custom Bar - Pinecrest.webp', import.meta.url).href;
const designImg = new URL('../assets/NewPortfolio/Commercial/Italian Restaurant - Miami Beach.webp', import.meta.url).href;
const constructionImg = new URL('../assets/NewPortfolio/Commercial/Hotel Renovation - Downtown Miami.webp', import.meta.url).href;
