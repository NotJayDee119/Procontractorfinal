...
const JuanHeadshot = new URL('../assets/Juan_Headshot.jpg', import.meta.url).href;
const PaolaHeadshot = new URL('../assets/Paola_Headshot.jpg', import.meta.url).href;

const About = () => {
  const navigate = useNavigate();
  const handleNavigateContact = useCallback(() => navigate('/contact'), [navigate]);
  const handleNavigateJuan = useCallback(() => navigate('/team/juan'), [navigate]);
  const handleNavigatePaola = useCallback(() => navigate('/team/paola'), [navigate]);
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <button onClick={handleNavigateContact} className="mt-8 px-10 py-4 bg-[#333333] text-[#f6f1ef] rounded-full font-wix-madefor font-bold hover:bg-[#5b5b5b] transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl inline-flex items-center gap-3 group">
                GET A QUOTE
      ...
      <section className="py-28 bg-[#f6f1ef]">
        <div className="max-w-5xl mx-auto px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            <button onClick={handleNavigateContact} className="px-10 py-4 bg-transparent border-2 border-[#333333] text-[#333333] rounded-full font-wix-madefor font-bold hover:bg-[#333333] hover:text-[#f6f1ef] transition-all duration-300 hover:scale-105 min-w-[240px]">
             GET A QUOTE
            </button>
          </div>
