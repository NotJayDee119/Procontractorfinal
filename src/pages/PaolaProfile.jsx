...
const PaolaProfile = () => {
  ...
  useEffect(() => {
    // Set document title
    document.title = 'Paola Dos Santos - Co-Founder | Pro Contractors';
    
    // Ensure the component is ready to render
    setIsReady(true);
    
    return () => {
      document.title = 'Pro Contractors';
    };
  }, []);
  ...
  return (
    <div className="min-h-screen bg-[#333333]">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-[#333333] overflow-hidden pt-24">
