...
// Lazy load kitchen images
const kitchenImg1 = new URL('../../assets/NewPortfolio/Kitchen/Kitchen Remodeling - Miami Shores.webp', import.meta.url).href;
const kitchenImg2 = new URL('../../assets/NewPortfolio/Kitchen/Kitchen Remodeling - Downtown Miami.webp', import.meta.url).href;
const kitchenImg3 = new URL('../../assets/NewPortfolio/Kitchen/Kitchen Remodeling - Miami.webp', import.meta.url).href;

const KitchenRenovations = () => {
  const navigate = useNavigate();
  const handleNavigateContact = useCallback(() => navigate('/contact'), [navigate]);
  const handleNavigatePortfolio = useCallback(() => navigate('/portfolio', { state: { category: 'Kitchen' } }), [navigate]);
