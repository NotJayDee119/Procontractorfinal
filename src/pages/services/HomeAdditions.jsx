...
// Lazy load home addition images
const additionImg1 = new URL('../../assets/NewPortfolio/Home Additions/Custom Bar - Pinecrest.webp', import.meta.url).href;
const additionImg2 = new URL('../../assets/NewPortfolio/Home Additions/Hotel Remodeling - Sunny Isles Beach.webp', import.meta.url).href;
const additionImg3 = new URL('../../assets/NewPortfolio/Residential/Custom Bar - Pinecrest.webp', import.meta.url).href;
...
const HomeAdditions = () => {
  ...
  const handleNavigatePortfolio = useCallback(() => navigate('/portfolio', { state: { category: 'Home Additions' } }), [navigate]);
