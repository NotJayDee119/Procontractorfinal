...
// Lazy load new construction images
const constructionImg1 = new URL('../../assets/NewPortfolio/Commercial/Hotel Renovation - Downtown Miami.webp', import.meta.url).href;
const constructionImg2 = new URL('../../assets/NewPortfolio/Commercial/Hotel Remodeling - Sunny Isles Beach.webp', import.meta.url).href;
const constructionImg3 = new URL('../../assets/NewPortfolio/Commercial/Italian Restaurant - Miami Beach.webp', import.meta.url).href;
...
const NewConstruction = () => {
  ...
  const handleNavigatePortfolio = useCallback(() => navigate('/portfolio', { state: { category: 'Commercial' } }), [navigate]);
