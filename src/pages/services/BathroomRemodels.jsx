...
// Lazy load bathroom images
const bathroomImg1 = new URL('../../assets/NewPortfolio/Bathroom/Bathroom Remodeling - Coral Gables.webp', import.meta.url).href;
const bathroomImg2 = new URL('../../assets/NewPortfolio/Bathroom/Bathroom Remodeling - Miami Beach.webp', import.meta.url).href;
const bathroomImg3 = new URL('../../assets/NewPortfolio/Bathroom/Home Remodeling - Sunny Isles Beach.webp', import.meta.url).href;
...
const BathroomRemodels = () => {
  ...
  const handleNavigatePortfolio = useCallback(() => navigate('/portfolio', { state: { category: 'Bathroom' } }), [navigate]);
