...
// Lazy load home remodeling images
const homeImg1 = new URL('../../assets/NewPortfolio/Home Additions/Hotel Remodeling - Sunny Isles Beach.webp', import.meta.url).href;
const homeImg2 = new URL('../../assets/NewPortfolio/Residential/Home Remodeling - Fort Lauderdale.webp', import.meta.url).href;
const homeImg3 = new URL('../../assets/NewPortfolio/Residential/Home Remodeling - Sunny Isles.webp', import.meta.url).href;
...
const HomeRemodeling = () => {
  ...
  const handleNavigatePortfolio = useCallback(() => navigate('/portfolio', { state: { category: 'Residential' } }), [navigate]);
  const handleNavigateServices = useCallback(() => navigate('/services'), [navigate]);
