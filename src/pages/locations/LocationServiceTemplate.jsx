...
const LocationServiceTemplate = ({ cityName, serviceData }) => {
    // Safety check for missing data
    if (!serviceData || !cityName) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="text-center px-8">
                    <h1 className="text-4xl font-custom text-[#2a2a2a] mb-4">Service Not Found</h1>
                    <p className="text-gray-600 mb-6">The requested service information is not available.</p>
                    <a href="/" className="bg-[#2a2a2a] text-white py-3 px-8 rounded-lg font-wix-madefor font-semibold hover:bg-[#1a1a1a] transition-all duration-300 inline-block">
                        Return Home
                    </a>
                </div>
            </div>
...
${formData.message}
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Trust Your Contracting Needs Section */}
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-8">
            ...
            {/* Local CTA Section - Request a Quote */}
