...
const CoralGablesKitchenRemodeling = () => {
...
${formData.message}
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Work With the Best Professionals Section */}
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        <div>
                            ...
                            <h2 className="text-[42px] font-custom text-[#2a2a2a] mb-6">
                                Work With the Best Professionals in Contracting
                            </h2>
                            <p className="text-gray-600 font-wix-madefor text-[16px] leading-relaxed mb-8">
...
export default CoralGablesKitchenRemodeling;
