            ...
            <section className="relative pt-40 pb-28 bg-[#333333] overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-8 text-center relative z-10">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#5b5b5b]/30 rounded-full mb-8 backdrop-blur-sm">
                        ...
                        <span className="text-[#f6f1ef] font-wix-madefor text-sm font-medium tracking-wide">Broward</span>
                    </div>
                    ...
                    <p className="text-[#f6f1ef]/80 font-wix-madefor text-[16px] max-w-3xl mx-auto leading-relaxed">
                        Premier General Contracting Services in Broward County.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="order-2 lg:order-1">
                            <div className="rounded-lg overflow-hidden shadow-lg">
                                <img
                    src="https://floridascenichighways.com/wp-content/uploads/2025/05/Deerfield-Beach-aerial.jpg"
                        ...
                        <div className="order-1 lg:order-2 space-y-6">
                            <p className="text-gray-700 leading-relaxed font-wix-madefor text-[16px]">
                                Broward County is home to some of South Florida's most beautiful communities, from the beaches of Fort Lauderdale to the vibrant streets of Hollywood and beyond. Bring your dream home to life with a new construction project or a custom remodel with Procontractors LLC, your trusted general contractors in Broward County.
                            </p>

                            <div className="pt-6">
                                <h3 className="text-[32px] font-custom text-[#2a2a2a] mb-4">
                                    Broward County General Contractor
                                </h3>
                                <p className="text-gray-700 leading-relaxed font-wix-madefor mb-6 text-[16px]">
                                    A successful home improvement project requires a skilled professional to manage every detail from planning to execution. Procontractors LLC coordinates all aspects of your project, so you don't have to deal with multiple contractors. We ensure a smooth, seamless process from start to finish, turning your vision into reality.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="mb-16">
                        <h3 className="text-[32px] font-custom text-[#2a2a2a] mb-4 text-center">
                            Contractors in Broward Specializing in Tile Work and Renovation Projects
                        </h3>
                        <p className="text-gray-700 leading-relaxed font-wix-madefor text-[16px]">
                    ...
                    <div className="mb-16">
                        <h3 className="text-[32px] font-custom text-[#2a2a2a] mb-12 text-center">
                            Services Offered in Broward and South Florida
                        </h3>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
                            ...
                            <div className="bg-white rounded-3xl p-10 hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group w-full max-w-sm mx-auto border border-gray-200 hover:border-[#2a2a2a]/20">
                                <div className="flex flex-col items-center text-center space-y-6">
                                    ...
                                    <p className="text-gray-600 text-[16px] leading-relaxed font-wix-madefor">
                                        Modern, functional, and beautiful culinary spaces.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-10 hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group w-full max-w-sm mx-auto border border-gray-200 hover:border-[#2a2a2a]/20">
                                <div className="flex flex-col items-center text-center space-y-6">
                                    ...
                                    {/* Description */}
                                    <p className="text-gray-600 text-[16px] leading-relaxed font-wix-madefor">
                                        Luxury upgrades designed to create spa-like retreats.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-10 hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group w-full max-w-sm mx-auto border border-gray-200 hover:border-[#2a2a2a]/20">
                                <div className="flex flex-col items-center text-center space-y-6">
                                    ...
                                    {/* Description */}
                                    <p className="text-gray-600 text-[16px] leading-relaxed font-wix-madefor">
                                        Custom solutions to enhance flow, style, and comfort throughout your home.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-10 hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group w-full max-w-sm mx-auto border border-gray-200 hover:border-[#2a2a2a]/20">
                                <div className="flex flex-col items-center text-center space-y-6">
                                    ...
                                    {/* Description */}
                                    <p className="text-gray-600 text-[16px] leading-relaxed font-wix-madefor">
                                        Expand your living space with expert planning and execution.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <section className="my-20">
                        <p className="text-gray-700 leading-relaxed font-wix-madefor text-center max-w-4xl mx-auto text-[16px]">
                            As general contractors serving Broward County, we focus on craftsmanship, attention to detail, and personalized service on every project. Contact us today for a free estimate and start transforming your home with Procontractors LLC.
                        </p>
                    </section>
                </div>
            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center gap-4 p-6 bg-[#2a2a2a] text-white rounded-xl border-2 border-[#2a2a2a]">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[16px] font-custom font-semibold">Broward</span>
                                ...
                                <div className="flex gap-5 group">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[#5b5b5b] font-wix-madefor text-[16px] leading-relaxed">
                                            <a href="https://www.google.com/maps/place/Broward+County,+FL" target="_blank" rel="noopener noreferrer" className="hover:text-[#333333] transition-colors">
                                                Broward
                                            </a>
                                        </div>
                                    </div>
