            ...
            <section className="relative pt-40 pb-28 bg-[#333333] overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-8 text-center relative z-10">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#5b5b5b]/30 rounded-full mb-8 backdrop-blur-sm">
                        ...
                        <span className="text-[#f6f1ef] font-wix-madefor text-sm font-medium tracking-wide">Coral Gables</span>
                    </div>
                    ...
                    <p className="text-[#f6f1ef]/80 font-wix-madefor text-[16px] max-w-3xl mx-auto leading-relaxed">
                        Premier General Contracting Services in Coral Gables.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-8">
                    ...
                    <div className="mb-16">
                        ...
                        <h2 className="text-[42px] font-custom text-[#2a2a2a] mb-8">
                            General Contractors Coral Gables
                        </h2>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="order-2 lg:order-1">
                            <div className="rounded-lg overflow-hidden shadow-lg">
                                <img
                    src="https://lh3.googleusercontent.com/gps-cs-s/AG0ilSxUaTRy8rLSs7MQHPOofXFb_XcmqyaMDlj-W4TrM3TyRDIYOyrl9T2etDW6-DU-b1D1A95kNEZPDrtGNiWfCja1ODCJnk2_jzSeENKuMwT-EPN5nVcr8ZG9KCnuWNYET1SFetRr=s387-k-no"
                        ...
                        <div className="order-1 lg:order-2 space-y-6">
                            <p className="text-gray-700 leading-relaxed font-wix-madefor text-[16px]">
                                Coral Gables is known for its elegant architecture, tree-lined streets, and luxurious homes. Turn your vision into reality with a new construction project or a home remodel with Procontractors LLC, your trusted general contractors in Coral Gables.
                            </p>

                            <div className="pt-6">
                                <h3 className="text-[32px] font-custom text-[#2a2a2a] mb-4">
                                    Coral Gables General Contractor
                                </h3>
                                <p className="text-gray-700 leading-relaxed font-wix-madefor mb-6 text-[16px]">
                                    Home improvement projects require careful planning and professional coordination. Procontractors LLC manages every detail, from design to completion, so you don't have to juggle multiple contractors. We make the process seamless, ensuring your project is completed on time and to your exact specifications.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="mb-16">
                        <h3 className="text-[32px] font-custom text-[#2a2a2a] mb-4 text-center">
                            Contractors in Coral Gables Specializing in Tile Work and Renovation Projects
                        </h3>
                        <p className="text-gray-700 leading-relaxed font-wix-madefor text-[16px]">
                    ...
                    <div className="mb-16">
                        <h3 className="text-[32px] font-custom text-[#2a2a2a] mb-12 text-center">
                            Services Offered in Coral Gables and South Florida
                        </h3>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
                            ...
                            <div className="bg-white rounded-3xl p-10 hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group w-full max-w-sm mx-auto border border-gray-200 hover:border-[#2a2a2a]/20">
                                <div className="flex flex-col items-center text-center space-y-6">
                                    ...
                                    <p className="text-gray-600 text-[16px] leading-relaxed font-wix-madefor">
                                        Stylish, modern, and functional designs for your cooking space.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-10 hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group w-full max-w-sm mx-auto border border-gray-200 hover:border-[#2a2a2a]/20">
                                <div className="flex flex-col items-center text-center space-y-6">
                                    ...
                                    {/* Description */}
                                    <p className="text-gray-600 text-[16px] leading-relaxed font-wix-madefor">
                                        Personalized solutions to enhance comfort, flow, and style throughout your home.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl p-10 hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 group w-full max-w-sm mx-auto border border-gray-200 hover:border-[#2a2a2a]/20">
                                <div className="flex flex-col items-center text-center space-y-6">
                                    ...
                                    {/* Description */}
                                    <p className="text-gray-600 text-[16px] leading-relaxed font-wix-madefor">
                                        Expand your living space with expert craftsmanship.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <section className="my-20">
                        <p className="text-gray-700 leading-relaxed font-wix-madefor text-center max-w-4xl mx-auto text-[16px]">
                            As general contractors serving Coral Gables, we pride ourselves on exceptional craftsmanship, attention to detail, and personalized service for every project. Contact us today for a free estimate and start building your dream home with Procontractors LLC.
                        </p>
                    </section>
                </div>
            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center gap-4 p-6 bg-[#2a2a2a] text-white rounded-xl border-2 border-[#2a2a2a]">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[16px] font-custom font-semibold">Coral Gables</span>
                        ...
                        >
                            ...
                            <span className="text-[16px] font-custom text-[#2a2a2a] font-semibold">Fort Lauderdale</span>
                        </Link>
                                ...
                                <div className="flex gap-5 group">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-[#5b5b5b] font-wix-madefor text-[16px] leading-relaxed">
                                            <a href="https://www.google.com/maps/place/Coral+Gables,+FL" target="_blank" rel="noopener noreferrer" className="hover:text-[#333333] transition-colors">
                                                Coral Gables
                                            </a>
                                        </div>
                                    </div>
