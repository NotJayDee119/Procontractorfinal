...
// Services data - icons are functions that return JSX
export const services = {
  remodeling: [
    {
      title: "Kitchen Renovations",
      icon: () => (
        <img src={mixerImage} alt="Kitchen Mixer" className="w-16 h-16 object-contain" />
      )
    },
    {
      title: "Bathroom Remodels",
      icon: () => (
        <img src={bathtubImage} alt="Bathtub" className="w-16 h-16 object-contain" />
      )
    },
    {
